...
<head>
    ...
    <title>4tAble - Donate For INDIA!</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <h1 class="my-4"> <b>4tAble</b>
                    <small>Donate For INDIA!</small>
                </h1>
...
<?php echo "Total: ".$prow['amount']." INR";?>
</div>
<div class = "text-muted" style = "float:left;">
<?php 
if(isset($current))
echo "Current: ".$current." INR";
else echo "Current: 0 INR";
?>
    ...
    $uspk = mysqli_fetch_array($findans);
            ...
            <div class="col-md-4">
                        ...
                        <div class="row">
                           ...
                           <?php
                            ...
                            while($frow = mysqli_fetch_array($fqres))
                            {
                                ...
                                echo "&#10003; ".$frow['donation_username']." donated ".$frow['donation_amount']." INR on ".$frow['p_title'];
                               echo '</div>';
                            }
                    ...
                    <div class="card-body">
                        <?php
                            ...
                            while($ans = mysqli_fetch_array($lexec)){
                                ...
                                echo $ans['p_user_name']." requested ".$ans['amount']." INR on "." <a href=".$rurl.">".$ans['p_title']."</a>";
                                echo '</div>';
                            }
                    mysqli_close($link);
                        ?>
                ...
                <div class="card my-4">
                    ...
                    <div class="card-body">
                        4tAble is a website made to combine the rich and poor digitally and eradicate the poverty of India.
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">According to World Bank, India's poverty rate is 6.7% in 2019,as measured by the percentage of people living below the international extreme poverty line.</p>
