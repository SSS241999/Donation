...
<body>
    <section class="jumbotron text-center">
        <div class="container">
            <h1 class="jumbotron-heading">4tAble Contact</h1>
            <p class="lead text-muted mb-0">Donate for INDIA!
            ...
            <div class="col-12 col-sm-4">
                <div class="card bg-light mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <p>VIT campus, Wadala</p>
                        <p>INDIA</p>
                        <p>Email : info@4table.com</p>
                        <p>Phone : +91 750-602-5018</p>
