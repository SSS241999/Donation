...
<div class = "col-6">
             ...
             if(isset($_SESSION['userId'])){
                 if($_SESSION['userId'] == $userinfo_username){
                    ...
                    if(isset($final['balance']))
                     echo'<p>Total Donations Recieved: '.$final['balance'].' INR</p>';
   ...
   if(mysqli_num_rows($donationresult) > 0){
    ...
    echo $userinfo_username." donated ".$d['donation_amount'].' INR on '.$d['p_title'].'<br>'; 
    }
   }
   ?>
   <br>
   ...
   <?php 
    if(mysqli_num_rows($mysqlresult)> 0){
        ...
        echo $userinfo_username." requested ".$p['amount'].' INR on topic '.$p['p_title'].'<br>'; 
        }
       }
